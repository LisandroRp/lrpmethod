...
export type LandingContent = {
  ...
  auth: {
    ...
    resetPasswordPageDescription: string;
    resetPasswordSuccessMessage: string;
    resetPasswordRedirectingMessage: string;
    resetPasswordInvalidLinkMessage: string;
    resetPasswordGenericError: string;
    resetPasswordInvalidTokenMessage: string;
    resetPasswordConfirmCta: string;
    genericError: string;
    accountLabel: string;
    planLabel: string;
